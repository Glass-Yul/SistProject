			...
			<table class="table table-bordered">
  			  ...
  			  <td >
  			    <div class="d-inline-flex">
	  			    <input type="text" class="form-control" style="width: 120px;" name="id" required="required" readonly="readonly">
  			...
  			<tr>
  			  ...
  			  <td>
  			    ...
  			    style="width: 120px;" name="pass" required="required">
  			  </td>
  			</tr>
  			...
  			<tr>
  			  ...
  			  <td>
  			    ...
  			    style="width: 120px;" name="name" required="required">
  			  </td>
  			</tr>
  			...
  			<tr>
  			  ...
  			  <td>
  			    ...
  			    style="width: 200px;" name="photo" required="required">
  			  </td>
  			</tr>
  			...
  			<tr>
  			  ...
  			  <td>
  			    <input type="text" class="form-control"
  			    style="width: 180px;" name="hp" required="required">
  			  </td>
  			</tr>
